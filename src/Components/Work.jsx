    ...
    return (
        <div id='work' className='section3'>
            ...
            <div className="mai-con">
                ...
                <div className="btn-viewAll" onClick={{trackViewAllBtnClick}}><a className='invisible-a' href=""></a><Link className='visible-a' to="/AllProjects"> View All</Link></div>
                <div className="both-big-con">
                    <div className="big-box-work">
                        <div className="con1-work">
                            ...
                            <div className="readmoreRoyal" onClick={royalReadmoreBtn}><Link className='Link' to="/Project1" onClick={handleClick} > <div className="button"><span >Read More</span></div></Link></div>
                        </div>
                        ...
                        <div className="con3-work">
                           ...
                           <div className="readMoreSnacko" onClick={snackoReadMoreBtn} > <Link className='Link' to="/Project2"> <div className="button"><span >Read More</span></div></Link></div>
                        </div>
                    </div>
                    <div className="big-box-work2">
                        <div className="con1-work">
                            ...
                            <div className="readMoreKanishka"onClick={kanishkaReadMoreBtn} ><Link className='Link' to="/Project3"> <div className="button"><span >Read More</span></div></Link></div>
                        </div>
                        <div className="con3-work">
                           ...
                           <div className="readMorePanchayatSamiti" onClick={panchayatSamitiReadMorebtn}> <Link className='Link' to="/Project4"> <div className="button"><span >Read More</span></div></Link></div>
                        </div>
                    </div>
                </div>
            </div>
