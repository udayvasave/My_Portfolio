...
const Work = () => {
   ...
   const snackoReadMoreAllBtnClick = ()=> {
    window.gtag('event', 'click', {
        'event_category': 'Button Clicks',
        'event_action': 'View All Button Click',
        'event_label': 'View All'
   ...
   const kanishkaReadMoreBtnClick = ()=> {
    window.gtag('event', 'click', {
        'event_category': 'Button Clicks',
        'event_action': 'View All Button Click',
        'event_label': 'View All'
    ...
    return (
        <div id='work' className='section3'>
            ...
            <div className="mai-con">
                ...
                <div className="btn-viewAll"><Link  className='visible-a' to="/AllProjects" > View All</Link></div>
